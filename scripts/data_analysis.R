...
#' 
#' # 1. CedV / NiV comparison (Figure 2)
#' 
#' ## 1.1. Data exploration
#' 
#' ### 1.1.1. CSE and fusion 
#' 
## ---- fig.width = 24 / 2.54, fig.height = 7 / 2.54----------------------------------------------------------------------------------------------
...
#' 
#' # 2. Headless mutant exploration (Figure 3)
#' 
#' ## 2.1. Data exploration
#' 
#' ### 2.1.1. CedV mutant fusion
#' 
## ---- warning = F, fig.width = 24 / 2.54, fig.height = 7 / 2.54---------------------------------------------------------------------------------
...
#' 
#' # 3. Tag effect exploration (Figure 4)
#' 
...
#' 
#' # 4. Avidity selected mutants (Figure 5)
#' 
...
#' 
#' # 5. Tagged NiV and HeV mutants (Figure S1)
#' 
...
#' 
## ---- warning = F, fig.width = 14 / 2.54, fig.height = 10 / 2.54--------------------------------------------------------------------------------
